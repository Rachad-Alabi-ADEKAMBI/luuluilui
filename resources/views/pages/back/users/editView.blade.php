        ...
        <div class="container">
            <div class="row">
                <div
                    ...
                    <form action="{{url('edit',$ad->id)}}" method="GET" enctype="multipart/form-data" class="mx-auto">
                        @csrf
                        ...
                        <div class="row mt-3">
                            <div class="form-group col-md-12 col-lg-4">
                                ...
                                <input type="text" class="form-control" name="engine" id="inputEmail4"
                                    placeholder="Moteur" value="honda">
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="form-group col-md-12 col-lg-4">
                                ...
                                <input type="number" class="form-control" name="kilometers" id="inputEmail4"
                                    placeholder="Kilométrage au compteur" value="">
                            </div>

                            <div class="form-group col-md-12 col-lg-4">
                                <label for="inputEmail4">Carosserie: <span>*</span></label>
                                <input type="text" class="form-control" name="body" id="inputEmail4"
                        ...
                        <div class="row mt-3">
                            <div class="form-group col-md-12 col-lg-4">
                                ...
                                <input type="number" class="form-control" name="places" id="inputEmail4"
                                    placeholder="Nombre de places" value="">
                            </div>
